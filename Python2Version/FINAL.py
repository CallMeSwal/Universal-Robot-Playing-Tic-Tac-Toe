...
command=[["set_digital_out(3,False)", "set_digital_out(2,False)", "set_digital_out(1,False)", "set_digital_out(0,True)"],
         ["set_digital_out(3,False)", "set_digital_out(2,False)", "set_digital_out(1,True)", "set_digital_out(0,False)"],
         ["set_digital_out(3,False)", "set_digital_out(2,False)", "set_digital_out(1,True)", "set_digital_out(0,True)"],
         ["set_digital_out(3,False)", "set_digital_out(2,True)", "set_digital_out(1,False)", "set_digital_out(0,False)"],
         ["set_digital_out(3,False)", "set_digital_out(2,True)", "set_digital_out(1,False)", "set_digital_out(0,True)"],
         ["set_digital_out(3,False)", "set_digital_out(2,True)", "set_digital_out(1,True)", "set_digital_out(0,False)"],
         ["set_digital_out(3,False)", "set_digital_out(2,True)", "set_digital_out(1,True)", "set_digital_out(0,True)"],
         ["set_digital_out(3,True)", "set_digital_out(2,False)", "set_digital_out(1,False)", "set_digital_out(0,False)"],
         ["set_digital_out(3,True)", "set_digital_out(2,False)", "set_digital_out(1,False)", "set_digital_out(0,True)"]]
...
while(True):
    ...
    if (k%256 == 27):
        ...
        time.sleep(0.25)
        s.send(" "+command[pos][0] + "\n")
        time.sleep(1)
        s.send(" "+command[pos][1] + "\n")
        time.sleep(1)
        s.send(" "+command[pos][2] + "\n")
        time.sleep(0.25)
        s.send(" "+command[pos][3] + "\n")
        time.sleep(0.25)
        '''
        time.sleep(0.25)
